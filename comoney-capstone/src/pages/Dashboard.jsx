    ...
    <div className="container dashboard__container px-3">
            ...
            <div className="card-content">
              <article className="card__balance py-3 d-flex align-items-center px-4 mt-3">
                ...
                <div className="balance__container ms-4">
                  ...
                  <p className="small__font">Rp 1.200.000</p>
                </div>
              </article>
              <article className="card__income-expense py-3 px-4 mt-3">
                ...
                <div className="income d-flex align-items-center">
                  ...
                  <div className="income__container ms-4">
                    ...
                    <p className="small__font">Rp 500.000</p>
                  </div>
                </div>
                <div className="expense d-flex align-items-center">
                  ...
                  <div className="expense__container ms-4">
                    ...
                    <p className="small__font">Rp 200.000</p>
                  </div>
                </div>
              </article>
              <article className="card__income-expense py-3 px-4 mt-3">
                ...
                <div className="income d-flex align-items-center">
                  ...
                  <div className="income__container ms-4">
                    <h3 className="fw-bold small__font">Income</h3>
                    <p className="small__font">Rp 1.000.000</p>
                  </div>
                </div>
                <div className="expense d-flex align-items-center">
                  <BsGraphDown className='graph-down'/>
      ...
      <section className="list__transaction">
        ...
        <div className="transaction__content">
          <p className="transaction__date px-3 py-2 mb-3 mt-4 small__font">12 November 2022</p>
          <li className="d-flex justify-content-between align-items-center mb-3">
            <div className="d-flex mb-2 align-items-center">
              <BsFillArrowDownCircleFill/>
              <p className="fw-bold ms-2 small__font">Shopping</p>
            </div>
            <p className="fw-bold green small__font">Rp 800.000</p>
          </li>
          <li className="d-flex justify-content-between align-items-center mb-3">
            <div className="d-flex mb-2 align-items-center">
              <BsFillArrowUpCircleFill/>
              <p className="fw-bold ms-2 small__font">Freelance</p>
            </div>
            <p className="fw-bold red small__font">Rp 200.000</p>
          </li>
        </div>
      </section>
    </div>
