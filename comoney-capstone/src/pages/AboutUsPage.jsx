        ...
        <div className="row">
          <div className="col-lg-4 col-md-4 d-flex justify-content-center mb-4">
            <div className="card" style={{ width: '18rem' }}>
              <img src="https://via.placeholder.com/350" className="card-img-top" alt="Ryan Hertanto" />
          ...
          <div className="col-lg-4 col-md-4 d-flex justify-content-center mb-4">
            <div className="card" style={{ width: '18rem' }}>
              <img src="https://via.placeholder.com/350" className="card-img-top" alt="Imam Faraz Aditya" />
              <div className="card-body">
          ...
          <div className="col-lg-4 col-md-4 d-flex justify-content-center mb-4">
            <div className="card" style={{ width: '18rem' }}>
              <img src="https://via.placeholder.com/350" className="card-img-top" alt="Vincent" />
              <div className="card-body">
